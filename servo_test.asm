...
$0004	$	_main:
;servo_test.c,2 :: 		void main()
;servo_test.c,4 :: 		trisb=0x00;
$0004	$1303			BCF	STATUS, RP1
$0005	$1683			BSF	STATUS, RP0
$0006	$0186			CLRF	TRISB, 1
;servo_test.c,5 :: 		while(1)
$0007	$	L_main_0:
;servo_test.c,7 :: 		for(i=0;i<100;i++)
...
;servo_test.c,9 :: 		portb= 0xff;
$0012	$30FF			MOVLW	255
$0013	$0086			MOVWF	PORTB
;servo_test.c,10 :: 		delay_us(1000);
$0014	$3002			MOVLW	2
...
$0021	$2820			GOTO	$-1
;servo_test.c,11 :: 		portb=0x00;
$0022	$0186			CLRF	PORTB, 1
;servo_test.c,12 :: 		delay_us(19000);
$0023	$3019			MOVLW	25
...
$0036	$	L_main_3:
;servo_test.c,14 :: 		for(i=0;i<100;i++)
...
;servo_test.c,16 :: 		portb= 0Xff;
$0040	$30FF			MOVLW	255
$0041	$0086			MOVWF	PORTB
;servo_test.c,17 :: 		delay_us(2000);
$0042	$3003			MOVLW	3
...
$004F	$284E			GOTO	$-1
;servo_test.c,18 :: 		portb= 0X00;
$0050	$0186			CLRF	PORTB, 1
;servo_test.c,19 :: 		delay_us(18000);
$0051	$3018			MOVLW	24
